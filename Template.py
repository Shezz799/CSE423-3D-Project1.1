...
def showScreen():
    ...
    if player_alive:
        ...
        # After the game ends, show the appropriate message.
        if game_won:
            draw_text(450, 500, "YOU WIN!", font=GLUT_BITMAP_TIMES_ROMAN_24)
        else:
            draw_text(420, 500, "GAME OVER", font=GLUT_BITMAP_TIMES_ROMAN_24)
